...
<!-- отмечаем цветом успешную регистрацию пира -->
<script>
    $( document ).ready(function() {

        $('td.registry').each(function(i,elem) {
            if ($(this).html()=="No") $(this).addClass( "no" );
            if ($(this).html()=="Registered") $(this).addClass( "registered" );
        });
...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Home', 'url'=>array('/org/index')),
